...
//      alertMessage(alertMessage: any) {
//          throw new Error('Method not implemented.');
//      }
//      organizationNameInput: any;
//      slugInput: any;
//      statusDropdown: any;
//      planTypeDropdown: any;
//      timezoneDropdown: any;
//      timezoneSearchInput: any;
//      imageInput: any;
//      cropAndUploadButton: any;
//      trialDaysInput: any;
//      firstNameInput: any;
//      lastNameInput: any;
//      emailInput: any;
...
//      phoneInput: any;
//      enableEmailNotificationsToggle: any;
//      saveChangesButton: any;
//      cancelButton: any;
//      backButton: any;
//      addOrgFormTitle(addOrgFormTitle: any) {
//          throw new Error('Method not implemented.');
//      }
//     organizationText: Locator;
//     browseFilesButton: Locator;
//     organizationForm: Locator;
//     addOrganizationButton: any;

//     constructor(Page:Page){
//       this.organizationText=Page.getByRole('heading',{name:'Organization'});
//       this.organizationForm=Page.locator('form');
//       this.browseFilesButton=Page.locator('button[type="button"])');


//     //image upload successful
//     readonly imageUploadSuccessMessage!: Locator;
//     //select plan type
//     readonly planTypeLocator!: Locator;
...
//    //status type
//    this.statusLocator=page.locator('select[name="status"]');
//    this.statusOptionLocator=page.locator('select[name="') 
...
export default class OrganizationLocators {
    ...
    readonly statusOptionLocator: Locator
    readonly imageUploadSuccessMessage!: Locator;
    readonly editLocator!: Locator;
    readonly deleteLocator!: Locator;
